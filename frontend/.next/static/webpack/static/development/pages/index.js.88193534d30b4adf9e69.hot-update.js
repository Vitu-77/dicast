...
/* harmony default export */ __webpack_exports__["default"] = ({
  isAuthenticated: function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(setLoading, isLoginPage) {
      var token, secretKey, _jwt$decode, auth, response, _isAuthenticated2;
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              _context.prev = 5;
              secretKey = '26sys323nosi188xzSXa98ZAA';
              _jwt$decode = jwt_simple__WEBPACK_IMPORTED_MODULE_5___default.a.decode(token, secretKey), auth = _jwt$decode.auth;
              console.log({
                auth: auth
              });
              _context.next = 11;
  ...
  authenticate: function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(username, password, _setUser, setLoginError, persistLogged) {
      var _ref, data, user, auth, error, payload, secretKey, encodedToken;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              secretKey = '26sys323nosi188xzSXa98ZAA';
              encodedToken = jwt_simple__WEBPACK_IMPORTED_MODULE_5___default.a.encode(payload, secretKey);
            ...
            case 12:
              if (persistLogged) {
                js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.set('DICAST_AUTH_TOKEN', encodedToken, {
                  expires: 50000
                });
            ...
            case 16:
              _context2.t0 = error;
              _context2.next = _context2.t0 === 'user not found' ? 19 : _context2.t0 === 'invalid password' ? 21 : 23;
              break;
...
//# sourceMappingURL=index.js.88193534d30b4adf9e69.hot-update.js.map
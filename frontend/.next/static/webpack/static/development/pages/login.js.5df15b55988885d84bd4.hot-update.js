...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  authenticate: function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(username, password, _setUser, setLoginError, persistLogged) {
      var _ref, data, user, auth, error, payload, SECRET, token, decoded;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              decoded = jwt_simple__WEBPACK_IMPORTED_MODULE_5___default.a.decode(token, SECRET);
              console.log({
                auth: auth,
                token: token,
                decoded: decoded
...
//# sourceMappingURL=login.js.5df15b55988885d84bd4.hot-update.js.map